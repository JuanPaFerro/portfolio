...
const Hello = () => {
  return (
    <section className="w-full px-4 flex flex-col justify-between">
      <div className="absolute w-44 h-48 left-4 top-60 bg-gradient-green opacity-40 blur-[174px]" />
      <div className="absolute w-44 h-48 right-4 bottom-60 bg-gradient-blue opacity-40 blur-[174px]" />
